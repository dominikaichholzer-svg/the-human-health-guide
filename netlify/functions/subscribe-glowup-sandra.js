...
// NOTIFY_EMAIL_SANDRA, Fallback Sandra.riedesser@gmx.at falls die Variable mal fehlt).
...
exports.handler = async function (event) {
  ...
  const NOTIFY_EMAIL = process.env.NOTIFY_EMAIL_SANDRA || 'Sandra.riedesser@gmx.at';
