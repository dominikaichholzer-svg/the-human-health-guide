// netlify/functions/subscribe-glowup-laura.js
//
...
//
// Aufruf vom Glow-up Quiz für Laura (glowup-quiz-laura.html) aus:
//   POST /.netlify/functions/subscribe-glowup-laura
//   Body: {
//     "name": "...",
...
//   2. Schickt eine Benachrichtigungs-Mail mit allen Angaben an Laura
//      über Resend (RESEND_API_KEY, NOTIFY_EMAIL_LAURA).
...
exports.handler = async function (event) {
  ...
  const ML_GROUP_ID = process.env.MAILERLITE_GLOWUP_LAURA_GROUP_ID;
